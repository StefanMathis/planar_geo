...
[`SegmentChain`]: https://docs.rs/planar_geo/{{VERSION}}/planar_geo/segment_chain/struct.SegmentChain.html
...
![]({{type_overview.svg}} "Overview geometric types of the planar_geo crate")
...
![]({{intersection_segments.svg}} "Point and segment intersection")
...
![]({{intersection_composites.svg}} "Intersection between contours and a segment chain")
...
[https://docs.rs/planar_geo/{{VERSION}}/planar_geo/](https://docs.rs/planar_geo/{{VERSION}}/planar_geo/).